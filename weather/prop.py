...
dfo=pd.read_excel("/home/mugunth/Desktop/allweather.xlsx")
cro=pd.read_excel("/home/mugunth/Desktop/weather/cropsa.xlsx")
...
nxtmonth = datetime.date(2018, mo+1, 1).strftime('%B')
nxtmonth=nxtmonth.lower()


cro=cro[(cro["soil"].str.contains(soil))]
cro=cro[ (cro["ideal time"].str.contains(month)) | (cro["ideal time"].str.contains(nxtmonth))]
